import type { ReportSnapshot } from "./snapshotSchema";
import { SNAPSHOT_SCHEMA_VERSION } from "./snapshotSchema";

/**
 * Curated default deck — rendered when no live snapshot has been handed over
 * from the Investment Decision Lab. Profile: CHF base / Moderate risk /
 * 15-year horizon / 60% target equity / look-through ON / normal regime.
 */
export const defaultReportData: ReportSnapshot = {
  ...
  etfs: [
    { n: 1, bucket: "US Large Cap", name: "iShares Core S&P 500 UCITS ETF (Acc)", isin: "IE00B5BMR087", ticker: "CSPX", exchange: "SIX", currency: "USD", distribution: "Acc", weight: "26.0%", terBps: 7, ter: "0.07%", comment: "Anchor of the equity sleeve; lowest TER in the book." },
    { n: 2, bucket: "Europe ex-CH", name: "iShares Core MSCI Europe UCITS ETF (Acc)", isin: "IE00B4K48X80", ticker: "IMEU", exchange: "SIX", currency: "EUR", distribution: "Acc", weight: "8.0%", terBps: 12, ter: "0.12%", comment: "EUR / GBP exposure paired with the Swiss sleeve." },
    { n: 3, bucket: "Switzerland", name: "UBS ETF MSCI Switzerland 20/35 UCITS ETF", isin: "LU0977261329", ticker: "CHSPI", exchange: "SIX", currency: "CHF", distribution: "Dist", weight: "6.0%", terBps: 20, ter: "0.20%", comment: "Capped index avoids Nestlé / Novartis / Roche concentration." },
    { n: 4, bucket: "Japan", name: "iShares Core MSCI Japan IMI UCITS ETF", isin: "IE00B4L5YX21", ticker: "IJPA", exchange: "SIX", currency: "JPY", distribution: "Acc", weight: "4.0%", terBps: 20, ter: "0.20%", comment: "Broad-market IMI; JPY unhedged." },
    { n: 5, bucket: "Emerging Mkts", name: "iShares Core MSCI EM IMI UCITS ETF", isin: "IE00BKM4GZ66", ticker: "EIMI", exchange: "SIX", currency: "USD", distribution: "Acc", weight: "8.0%", terBps: 18, ter: "0.18%", comment: "Boosted by the long-horizon EM tilt (×1.3 at ≥10 yrs)." },
    { n: 6, bucket: "World Small Cap", name: "SPDR MSCI World Small Cap UCITS ETF", isin: "IE00BCBJG560", ticker: "WOSC", exchange: "LSE", currency: "USD", distribution: "Acc", weight: "4.0%", terBps: 45, ter: "0.45%", comment: "Size factor diversifier with a long expected payoff." },
    { n: 7, bucket: "Real Estate", name: "iShares Developed Markets Property Yield UCITS", isin: "IE00B1FZS350", ticker: "IWDP", exchange: "LSE", currency: "USD", distribution: "Dist", weight: "4.0%", terBps: 59, ter: "0.59%", comment: "Listed REITs; income-tilted, equity-correlated." },
    { n: 8, bucket: "CHF Gov", name: "iShares Swiss Domestic Government Bond 7–15", isin: "CH0102530786", ticker: "CSBGC0", exchange: "SIX", currency: "CHF", distribution: "Dist", weight: "14.0%", terBps: 15, ter: "0.15%", comment: "Duration anchor in the home currency." },
    { n: 9, bucket: "CHF Corp", name: "iShares Core CHF Corporate Bond ETF", isin: "CH0226976816", ticker: "CHCORP", exchange: "SIX", currency: "CHF", distribution: "Dist", weight: "12.0%", terBps: 15, ter: "0.15%", comment: "Investment-grade credit spread, CHF native." },
    { n: 10, bucket: "Global Agg", name: "Xtrackers Global Aggregate Bond UCITS (CHF Hgd)", isin: "LU0942970442", ticker: "XBAG", exchange: "SIX", currency: "CHF", distribution: "Acc", weight: "12.0%", terBps: 25, ter: "0.25%", comment: "Diversifies issuers and yield curves; FX-hedged into CHF." },
  ],
  holdings: [
