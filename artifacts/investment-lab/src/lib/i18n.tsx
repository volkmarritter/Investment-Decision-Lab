...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "compare.slotB.defaultsStatement": "Portfolio B always starts from defaults — load a saved scenario to apply its overrides (weights, picked ETFs).",
  ...
  de: {
    ...
    "compare.slotB.defaultsStatement": "Portfolio B startet immer mit den Standardwerten – lade ein gespeichertes Szenario, um dessen Überschreibungen anzuwenden (Gewichte, ausgewählte ETFs).",
