...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "build.impl.freshness.both": "Core fund data verified against justETF on {coreDate}; per-exchange listings refreshed {listingsDate}.",
    "build.impl.freshness.coreOnly": "Core fund data verified against justETF on {coreDate}.",
    "build.impl.freshness.listingsOnly": "Per-exchange listings refreshed from justETF on {listingsDate}.",
    "build.impl.freshness.none": "Live data refresh has not run yet — values shown reflect the in-code defaults.",
  ...
  de: {
    ...
    "build.impl.freshness.both": "Kerndaten der Fonds am {coreDate} mit justETF abgeglichen; Börsenplatz-Listings am {listingsDate} aktualisiert.",
    "build.impl.freshness.coreOnly": "Kerndaten der Fonds am {coreDate} mit justETF abgeglichen.",
    "build.impl.freshness.listingsOnly": "Börsenplatz-Listings am {listingsDate} von justETF aktualisiert.",
    "build.impl.freshness.none": "Live-Datenabgleich wurde noch nicht ausgeführt — angezeigte Werte entsprechen den im Code hinterlegten Standardwerten.",
