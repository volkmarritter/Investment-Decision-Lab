...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "metrics.corr.desc": "Pairwise correlations between the asset classes actually held. Red = positively correlated, blue = negatively correlated.",
  ...
  de: {
    ...
    "metrics.corr.desc": "Paarweise Korrelationen der tatsächlich gehaltenen Anlageklassen. Rot = positiv korreliert, Blau = negativ korreliert.",
