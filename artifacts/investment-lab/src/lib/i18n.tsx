...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "etf.details.freshness.breakdowns": "Geo / sector / currency breakdown refreshed {date}.",
    "etf.details.freshness.breakdownsCurated": "Geo / sector / currency breakdown — curated reference date {date}.",
    "etf.details.freshness.topHoldings": "Top-holdings refreshed {date}.",
    "etf.details.freshness.topHoldingsCurated": "Top-holdings — curated reference date {date}.",
  ...
  de: {
    ...
    "etf.details.freshness.breakdowns": "Geo-/Sektor-/Währungs-Aufteilung aktualisiert am {date}.",
    "etf.details.freshness.breakdownsCurated": "Geo-/Sektor-/Währungs-Aufteilung — kuratierter Stichtag {date}.",
    "etf.details.freshness.topHoldings": "Top-Holdings aktualisiert am {date}.",
    "etf.details.freshness.topHoldingsCurated": "Top-Holdings — kuratierter Stichtag {date}.",
