...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "build.geomap.desc": "Country-level look-through of the equity sleeve. Regional buckets (Europe, EM, Other DM) are distributed across constituent countries by typical neutral cap weights.",
    "build.geomap.legend": "Share of equity sleeve",
    "build.geomap.noExposure": "No exposure",
    "build.geomap.disclaimer": "Indicative reference values, not live fund holdings. Hover a country to see its effective weight.",
  ...
  de: {
    ...
    "build.geomap.desc": "Länder-Look-Through des Aktienanteils. Regionale Buckets (Europa, EM, Sonstige DM) werden anhand typischer neutraler Marktkapitalisierungs-Gewichte auf die einzelnen Länder verteilt.",
    "build.geomap.legend": "Anteil am Aktienanteil",
    "build.geomap.noExposure": "Keine Allokation",
    "build.geomap.disclaimer": "Indikative Referenzwerte, keine Live-Fondsbestände. Land mit der Maus überfahren für die effektive Gewichtung.",
