...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "footer.bicon.tagline": "We build investment tools like this — talk to us about your project.",
  ...
  de: {
    ...
    "footer.bicon.tagline": "Wir bauen Anlagetools wie dieses — sprechen Sie uns auf Ihr Projekt an.",
