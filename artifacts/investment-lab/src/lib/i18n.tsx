...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "build.lookThrough.desc": "Decompose selected ETFs into their underlying country, sector and top-holding exposures to reveal hidden concentration and overlap.",
  ...
  de: {
    ...
    "build.lookThrough.desc": "Zerlegt die gewählten ETFs in ihre zugrundeliegenden Länder-, Sektor- und Top-Holding-Engagements, um verborgene Konzentrationen und Überlappungen sichtbar zu machen.",
