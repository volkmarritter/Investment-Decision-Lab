...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "build.preferredExchange.tooltip": "Filter ETFs by exchange listings where possible. \"None (European listings)\" lets the engine pick each ETF's most liquid European listing (LSE, XETRA, SIX or Euronext Amsterdam).",
