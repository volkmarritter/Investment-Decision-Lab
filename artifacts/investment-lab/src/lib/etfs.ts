...
const BUCKETS: Record<string, BucketAssignment> = {
  "Equity-Global": B({
    ...
    pool: ["IE00B4L5Y983", "IE00B0M62Q58", "IE00BFY0GT14", "IE00BK5BQV03", "IE00BP3QZ601", "IE00BP3QZB59", "IE00BP3QZ825", "IE00BD1F4M44", "IE00B9CQXS71", "IE00B5M1WJ87", "IE00BCHWNQ94", "IE00B3VWMM18"],
  }),
  "Equity-USA": B({
