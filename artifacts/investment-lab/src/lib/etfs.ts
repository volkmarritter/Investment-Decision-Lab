...
const INSTRUMENTS: Record<string, InstrumentRecord> = {
  ...
  "IE00B0M63177": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "EM equity — iShares MSCI Emerging Markets UCITS Dist.",
    commentDe: "EM-Aktien — iShares MSCI Emerging Markets UCITS Dist.",
  ...
  "LU0292107645": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "EM equity — Xtrackers MSCI Emerging Markets Swap UCITS 1C.",
    commentDe: "EM-Aktien — Xtrackers MSCI Emerging Markets Swap UCITS 1C.",
