...
const BUCKETS: Record<string, BucketAssignment> = {
  ...
  "Equity-Europe": B({
    ...
    pool: ["IE00B0M62S72", "DE0002635307", "LU0908500753", "IE00B53L4350", "IE00B0M62Y33", "DE0005933931", "LU0274211480"],
  }),
  ...
  "Equity-EM": B({
    ...
    pool: ["IE00B0M63177", "LU0292107645", "IE00B8KGV557", "IE00B52MJY50", "IE00B0M63730", "IE00BZCQB185", "IE00B02KXK85"],
  }),
  "Equity-USA-EUR": B({
  ...
  "FixedIncome-Global": B({
    ...
    pool: ["IE00B3VWN179", "IE00BSKRJZ44", "IE00B1FZSC47"],
  }),
