...
const BUCKETS: Record<string, BucketAssignment> = {
  ...
  "Equity-Europe": B({
    ...
    pool: ["IE00B0M62S72", "DE0002635307", "LU0908500753", "LU0274209237", "DE0005933931", "LU0274211480"],
  }),
  ...
  "Equity-EM": B({
    ...
    pool: ["IE00B0M63177", "IE00B8KGV557", "IE00B0M63730", "IE00BZCQB185", "IE00B02KXK85"],
  }),
  "Equity-USA-EUR": B({
  ...
  "Equity-Technology": B({
    ...
    pool: ["IE0032077012", "IE00BMFKG444", "IE00BYVQ9F29", "IE00BYZK4552"],
  }),
  "Equity-Healthcare": B({
