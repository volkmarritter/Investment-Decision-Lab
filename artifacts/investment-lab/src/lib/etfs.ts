...
const BUCKETS: Record<string, BucketAssignment> = {
  "Equity-Global": B({
    ...
    pool: ["IE00B4L5Y983", "IE00B0M62Q58", "IE00BFY0GT14", "LU0274208692", "IE00BK5BQV03", "IE00BP3QZ601", "IE00BP3QZB59", "IE00BP3QZ825", "IE00B9CQXS71", "IE00BCHWNQ94"],
  }),
  "Equity-USA": B({
  ...
  "Equity-Sustainability": B({
    ...
    pool: ["IE00BHZPJ569", "IE00BFNM3P36", "IE00BDBRT036"],
  }),
