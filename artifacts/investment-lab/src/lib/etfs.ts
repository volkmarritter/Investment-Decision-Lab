...
const INSTRUMENTS: Record<string, InstrumentRecord> = {
  "IE00B3YLTY66": I({
    ...
    commentDe: "Einzel-Fonds für globale Aktien (entwickelte + aufstrebende Märkte), der den MSCI ACWI IMI nachbildet; wird verwendet, wenn das ETF-Budget zu klein für regionale Aufteilungen ist.",
  ...
  "IE00B5BMR087": I({
    ...
    commentDe: "Größter, liquidester S&P 500 UCITS mit sehr enger Nachverfolgung und minimalen Geld-Brief-Spannen.",
  ...
  "IE00B3YCGJ38": I({
    ...
    commentDe: "Swap-basierte Replikation eliminiert die 15% US-Dividendenquellensteuer, die physische, in Irland ansässige ETFs erleiden, und fügt strukturell ~20–30 bps/Jahr hinzu; führt ein Gegenparteirisiko zu den Swap-Gegenparteien ein.",
  ...
  "IE00B4K48X80": I({
    ...
    commentDe: "Breite pan-europäische Kernexposition über das Vereinigte Königreich, die Eurozone und die Schweiz mit sehr niedrigem TER.",
  ...
  "IE00B53HP851": I({
    ...
    commentDe: "FTSE 100 Large-Cap UK-Aktien, die als GBP-heimische Kernkomponente verwendet werden; sehr niedriger TER und hohe Liquidität an der LSE.",
  ...
  "IE00B4L5YX21": I({
    ...
    commentDe: "Breite Japan-Exposition einschließlich kleiner Unternehmen; nützlich für eine diversifizierte entwickelte Märkte-Komponente.",
  ...
  "IE00BKM4GZ66": I({
    ...
    commentDe: "Der umfassendste Emerging-Markets-ETF einschließlich kleiner Unternehmen; die Sampling-Replikation hält den Tracking-Fehler niedrig.",
  ...
  "IE00B3ZW0K18": I({
    ...
    commentDe: "EUR-hedged Anteilsklasse entfernt USD/EUR FX-Volatilität; kleiner Einfluss durch Rollforward.",
  ...
  "IE00BYX5MS15": I({
    ...
    commentDe: "GBP-hedged Anteilsklasse für sterlingbasierte Anleger; identischer zugrunde liegender Korb.",
  ...
  "IE00B88DZ566": I({
    ...
    commentDe: "CHF-hedged Anteilsklasse für frankenbasierte Anleger; entfernt USD/CHF FX-Volatilität von der S&P 500-Exposition.",
  ...
  "IE00B3F81409": I({
    ...
    commentDe: "Diversifizierte globale Investment-Grade-Anleiheexposition; verfügbar in EUR, CHF und GBP-hedged Anteilsklassen.",
  ...
  "IE00BDBRDM35": I({
    ...
    commentDe: "EUR-hedged globaler Aggregate; bevorzugt für eurobasierte defensive Komponenten.",
  ...
  "IE00BDBRDN42": I({
    ...
    commentDe: "CHF-hedged globaler Aggregate; geeignete defensive Kernkomponente für Schweizer Franken-Portfolios.",
  ...
  "IE00BDBRDP65": I({
    ...
    commentDe: "GBP-hedged globaler Aggregate für Sterling-Portfolios.",
  ...
  "IE00B579F325": I({
    ...
    commentDe: "Physisch unterstützter Gold-ETC, der in London gelagert ist; sehr niedriger TER und enge Spreads im Vergleich zum Spot.",
  ...
  "IE00B1FZS350": I({
    ...
    commentDe: "Globale REITs aus entwickelten Märkten mit überdurchschnittlicher Dividendenrendite; bedeutendes US-Gewicht (~60%).",
  ...
  "GB00BLD4ZL17": I({
    ...
    commentDe: "Physisch unterstützter Bitcoin-ETP mit Cold-Storage-Custody; konzentrierte Einzelanlagenexposition.",
  ...
  "IE00B3WJKG14": I({
    ...
    commentDe: "Konzentrierte US-Technologie-Sektor-Neigung; hohe Konzentration auf Aktienebene in Mega-Cap-Namen.",
  ...
  "IE00BYZK4776": I({
    ...
    commentDe: "Globales Gesundheitsinnovations-Thema, das Biotechnologie, Geräte und digitale Gesundheit umfasst.",
  ...
  "IE00B1XNHC34": I({
    ...
    commentDe: "Konzentrierter globaler Clean-Energy-Korb; historisch hohe Volatilität und Sektor-Konzentration.",
  ...
  "IE00BG0J4C88": I({
    ...
    commentDe: "Globales Cybersecurity- und digitale Sicherheits-Thema; kleinere AUM, breitere Spreads möglich.",
  ...
  "IE00BK5BQT80": I({
    ...
    commentDe: "Vanguards Flaggschiff-Global-Equity-Fonds: Large/Mid Caps aus entwickelten und Schwellenländern, sehr hohe Liquidität an LSE/XETRA/SIX.",
  ...
  "IE00B6R52259": I({
    ...
    commentDe: "MSCI ACWI (entwickelte und Schwellenländer Large/Mid Caps); Schwesterfonds zu SPYI, jedoch auf dem MSCI ACWI Basisindex statt ACWI IMI (exklusive Small Caps).",
  ...
  "IE00BFMXXD54": I({
    ...
    commentDe: "Vanguards thesaurierender S&P 500 UCITS; gleiche TER wie iShares' CSPX, identischer zugrunde liegender Korb — nützlich zur Diversifizierung der Emittentenkonzentration.",
  ...
  "IE00B6YX5C33": I({
    ...
    commentDe: "Niedrigste TER S&P 500 UCITS im Katalog (3 bps); ausschüttende Anteilsklasse — vorzuziehen, wenn der Anleger regelmäßige Dividendenzahlungen statt Reinvestitionen wünscht.",
  ...
  "LU0490618542": I({
    ...
    commentDe: "Xtrackers S&P 500 Swap — alternative synthetische Lösung.",
  ...
  "IE00B945VV12": I({
    ...
    commentDe: "FTSE Developed Europe (Large/Mid Caps, einschließlich UK und Schweiz); geringfügig niedrigere TER als die iShares MSCI Variante.",
    ...
    commentDe: "Der EURO STOXX 50 konzentriert sich nur auf 50 Blue-Chip-Unternehmen der Eurozone, was ihn viel enger macht als breite MSCI- oder FTSE-Europe-Indizes, ohne UK- oder Schweizer Exposition.",
    commentSource: "manual",
  ...
  "CH0031768937": I({
    ...
    commentDe: "Swiss Leader Index (Top 30 Schweizer Blue Chips mit Gewichtungsobergrenzen); enger als der SPI, begrenzt jedoch die Dominanz von Nestlé / Novartis / Roche.",
  ...
  "LU1681044993": I({
    ...
    commentDe: "MSCI Schweiz (Large/Mid Caps, ~40 Namen); synthetisch, thesaurierend, in Luxemburg domiziliert — Alternative für Portfolios, die swap-basierte Replikation oder Ansammlung gegenüber der ausschüttenden Anteilsklasse des SPI-Standards bevorzugen.",
  ...
  "IE00B810Q511": I({
    ...
    commentDe: "Vanguard FTSE 100 — alternativer Anbieter, gleicher Index.",
  ...
  "LU0839027447": I({
    ...
    commentDe: "Xtrackers Nikkei 225 — Nikkei-Index-Alternative.",
  ...
  "IE00BK5BR733": I({
    ...
    commentDe: "Vanguard FTSE EM (Large/Mid Caps; einschließlich Korea — im Gegensatz zu MSCI EM); tiefere Spreads an LSE/XETRA.",
  ...
  "IE00BTJRMP35": I({
    ...
    commentDe: "Xtrackers MSCI EM — synthetisch, niedrige TER.",
  ...
  "IE00BM67HW99": I({
    ...
    commentDe: "Xtrackers S&P 500 EUR Hedged — alternativer Anbieter.",
  ...
  "IE00BRKWGL70": I({
    ...
    commentDe: "Invesco S&P 500 EUR Hedged — synthetische Alternative.",
  ...
  "LU0378818131": I({
    ...
    commentDe: "Souveränes globales Anleihenaggregat (exklusive Unternehmensanleihen); höhere TER als der iShares Core, aber saubereres Duration-Profil für defensive Segmente.",
  ...
  "IE00BG47KH54": I({
    ...
    commentDe: "Vanguard Global Aggregate Bond — alternativer Anbieter.",
  ...
  "IE00BG47KB92": I({
    ...
    commentDe: "Vanguard Global Aggregate Bond EUR Hedged — alternativer Anbieter.",
  ...
  "LU0290355717": I({
    ...
    commentDe: "Xtrackers II Global Government Bond EUR Hedged — nur Regierungsalternative.",
  ...
  "IE00BG47KJ78": I({
    ...
    commentDe: "Vanguard Global Aggregate Bond GBP Hedged — alternativer Anbieter.",
    ...
    commentDe: "Physisch besicherter Gold-ETC, gelagert bei JPMorgan in London; identische TER wie Invesco SGLD, nützlich für Emittenten-Diversifikation.",
    commentSource: "manual",
  ...
  "JE00B1VS3770": I({
    ...
    commentDe: "Höhere TER, aber lang etablierter physischer Gold-ETP (in Jersey ansässig); Barren bei HSBC London gehalten — nützlich als dritter Emittent neben Invesco/iShares.",
  ...
  "IE00B5L01S80": I({
    ...
    commentDe: "HSBC FTSE EPRA NAREIT Developed — alternativer Anbieter.",
  ...
  "NL0009690239": I({
    ...
    commentDe: "VanEck Global Real Estate — alternativer Anbieter.",
  ...
  "GB00BJYDH287": I({
    ...
    commentDe: "WisdomTree Physical Bitcoin — alternativer Krypto-ETP.",
  ...
  "CH1199067674": I({
    ...
    commentDe: "21Shares Bitcoin Core — in der Schweiz gelistet, natives CHF.",
  ...
  "IE00B53SZB19": I({
    ...
    commentDe: "Nasdaq 100 (Top 100 nicht-finanzielle Nasdaq-Namen); breiter als der IT-Sektor-Standard, aber immer noch technologieorientiert mit erheblichen Gewichten in den Bereichen Konsumgüter und Kommunikationsdienste.",
  ...
  "IE00BM67HT60": I({
    ...
    commentDe: "Xtrackers MSCI World IT — Technologiesektor der entwickelten Märkte, auf 35%/20% begrenzt, um die Konzentration auf Einzelwerte zu begrenzen.",
  ...
  "IE00BM67HK77": I({
    ...
    commentDe: "Xtrackers MSCI World Health Care — breite Gesundheitsversorgung.",
  ...
  "IE00B43HR379": I({
    ...
    commentDe: "iShares S&P 500 Health Care Sector — US-fokussierte Alternative.",
  ...
  "IE00BFNM3J75": I({
    ...
    commentDe: "iShares MSCI World ESG Screened — breite ESG-Alternative.",
  ...
  "IE00BLRB0242": I({
    ...
    commentDe: "Invesco Global Clean Energy — globales erneuerbare Energien-Thema, das den WilderHill New Energy Global Innovation Index verfolgt.",
  ...
  "IE00BYPLS672": I({
    ...
    commentDe: "L&G Cyber Security — reines Cybersecurity-Engagement.",
  ...
  "IE00BLPK3577": I({
    ...
    commentDe: "WisdomTree Cybersecurity — neuere Cybersecurity-Alternative.",
  ...
  "IE00BLCHJB90": I({
    ...
    commentDe: "Global X Robotics & AI — thematische Exposition gegenüber Robotik und KI-Nutznießern weltweit.",
  ...
  "IE00BLR6QB00": I({
    ...
    commentDe: "Global X Telemedicine & Digital Health — Nischen-Gesundheitstechnologie-Thema, sehr kleines AUM.",
  ...
  "LU0136234654": I({
    ...
    commentDe: "UBS MSCI USA — breite US-Blue-Chip-Aktien, ausschüttende Alternative.",
    ...
    currency: "EUR",
    comment: "The EURO STOXX 50 focuses on 50 Eurozone blue-chip companies only, making it much narrower than broad MSCI or FTSE Europe indices, with no UK or Swiss exposure.",
    commentDe: "Der EURO STOXX 50 konzentriert sich ausschließlich auf 50 Blue-Chip-Unternehmen der Eurozone, was ihn viel enger macht als breite MSCI- oder FTSE-Europe-Indizes, ohne UK- oder Schweizer Exposition.",
    commentSource: "manual",
  ...
  "IE00B3RBWM25": I({
    ...
    commentDe: "Vanguard FTSE All-World — entwickelte + aufstrebende Märkte weltweit, ausschüttende Anteilsklasse.",
  ...
  "LU0292100046": I({
    ...
    commentDe: "Xtrackers MSCI Korea — große/mittlere koreanische Aktien, auf 35%/20% begrenzt, um die Konzentration auf Einzelwerte zu begrenzen.",
  ...
  "IE00B4L5Y983": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Broad world equity — iShares Core MSCI World UCITS Acc.",
    commentDe: "Breite weltweite Aktien — iShares Core MSCI World UCITS Acc.",
  ...
  "IE00B0M62Q58": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Broad world equity — iShares MSCI World UCITS Dist.",
    commentDe: "Breite weltweite Aktien — iShares MSCI World UCITS Dist.",
  ...
  "IE00BFY0GT14": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Broad world equity — SPDR MSCI World UCITS Acc.",
    commentDe: "Breite weltweite Aktien — SPDR MSCI World UCITS Acc.",
  ...
  "LU0274208692": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Broad world equity — Xtrackers MSCI World UCITS 1C.",
    commentDe: "Breite weltweite Aktien — Xtrackers MSCI World UCITS 1C.",
  ...
  "IE00BK5BQV03": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Broad world equity — Vanguard ESG Global All Cap UCITS Acc.",
    commentDe: "Breite weltweite Aktien — Vanguard ESG Global All Cap UCITS Acc.",
  ...
  "IE0031442068": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "S&P 500 — iShares Core S&P 500 UCITS Dist.",
    commentDe: "S&P 500 — iShares Core S&P 500 UCITS Dist.",
  ...
  "IE00BYTRRD19": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "S&P 500 — Invesco S&P 500 UCITS Acc (synthetic alt).",
    commentDe: "S&P 500 — Invesco S&P 500 UCITS Acc (synthetische Alternative).",
  ...
  "IE0032077012": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "NASDAQ 100 — Invesco EQQQ Nasdaq-100 UCITS Dist.",
    commentDe: "NASDAQ 100 — Invesco EQQQ Nasdaq-100 UCITS Dist.",
  ...
  "IE00BMFKG444": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "NASDAQ 100 — Invesco EQQQ Nasdaq-100 UCITS Acc.",
    commentDe: "NASDAQ 100 — Invesco EQQQ Nasdaq-100 UCITS Acc.",
  ...
  "IE00BYVQ9F29": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "NASDAQ 100 — iShares Nasdaq 100 EUR Hedged UCITS.",
    commentDe: "NASDAQ 100 — iShares Nasdaq 100 EUR Hedged UCITS.",
  ...
  "LU1681038243": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "NASDAQ 100 — Lyxor Nasdaq-100 UCITS Acc (Amundi).",
    commentDe: "NASDAQ 100 — Lyxor Nasdaq-100 UCITS Acc (Amundi).",
  ...
  "IE00B0M62S72": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Europe broad — iShares STOXX Europe 600 UCITS Dist.",
    commentDe: "Europa breit — iShares STOXX Europe 600 UCITS Dist.",
  ...
  "DE0002635307": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Europe broad — iShares STOXX Europe 600 UCITS Dist (DE share class).",
    commentDe: "Europa breit — iShares STOXX Europe 600 UCITS Dist (DE Anteilsklasse).",
  ...
  "LU0908500753": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Europe broad — Lyxor STOXX Europe 600 UCITS Acc.",
    commentDe: "Europa breit — Lyxor STOXX Europe 600 UCITS Acc.",
  ...
  "IE00BKM4H312": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Europe broad — iShares Core MSCI Europe UCITS Dist.",
    commentDe: "Europa breit — iShares Core MSCI Europe UCITS Dist.",
  ...
  "LU0274209237": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Europe broad — Xtrackers MSCI Europe UCITS 1C.",
    commentDe: "Europa breit — Xtrackers MSCI Europe UCITS 1C.",
  ...
  "IE00B53L4350": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Eurozone — iShares Core EURO STOXX 50 UCITS Acc.",
    commentDe: "Eurozone — iShares Core EURO STOXX 50 UCITS Acc.",
  ...
  "LU0290358497": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Eurozone — Xtrackers EURO STOXX 50 UCITS 1C.",
    commentDe: "Eurozone — Xtrackers EURO STOXX 50 UCITS 1C.",
  ...
  "IE00B0M62Y33": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Eurozone — iShares MSCI EMU UCITS.",
    commentDe: "Eurozone — iShares MSCI EMU UCITS.",
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Der MSCI Emerging Markets Index bildet Aktien aus Schwellenländern weltweit ab.\n",
    commentDe: "Der iShares MSCI EM UCITS ETF (Dist) bildet den MSCI Emerging Markets Index nach. Der MSCI Emerging Markets Index bietet Zugang zu den größten und liquidesten Aktien aus Schwellenländern weltweit.",
    commentSource: "manual",
    ...
    currency: "USD",
    comment: "Der MSCI Emerging Markets Index bildet Aktien aus Schwellenländern weltweit ab.",
    commentDe: "Der Xtrackers MSCI Emerging Markets Swap UCITS ETF 1C bildet den MSCI Emerging Markets Index nach. Der MSCI Emerging Markets Index bietet Zugang zu den größten und liquidesten Aktien aus Schwellenländern weltweit.",
    commentSource: "manual",
  ...
  "IE00B8KGV557": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "EM equity — iShares Edge MSCI EM Min Volatility UCITS.",
    commentDe: "EM-Aktien — iShares Edge MSCI EM Min Volatility UCITS.",
  ...
  "IE00B53QDK08": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Japan equity — iShares Core MSCI Japan IMI UCITS Dist.",
    commentDe: "Japan-Aktien — iShares Core MSCI Japan IMI UCITS Dist.",
  ...
  "IE00B02KXH56": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Japan equity — iShares MSCI Japan UCITS Dist.",
    commentDe: "Japan-Aktien — iShares MSCI Japan UCITS Dist.",
  ...
  "LU0274209740": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Japan equity — Xtrackers MSCI Japan UCITS 1C.",
    commentDe: "Japan-Aktien — Xtrackers MSCI Japan UCITS 1C.",
  ...
  "IE00B52MJY50": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Asia ex-Japan — iShares Core MSCI Pacific ex-Japan UCITS.",
    commentDe: "Asien ohne Japan — iShares Core MSCI Pacific ex-Japan UCITS.",
  ...
  "IE00B0M63730": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Asia ex-Japan — iShares MSCI AC Far East ex-Japan UCITS.",
    commentDe: "Asien ohne Japan — iShares MSCI AC Far East ex-Japan UCITS.",
  ...
  "DE0005933931": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Germany equity — iShares Core DAX UCITS.",
    commentDe: "Deutschland-Aktien — iShares Core DAX UCITS.",
  ...
  "LU0274211480": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Germany equity — Xtrackers DAX UCITS 1C.",
    commentDe: "Deutschland-Aktien — Xtrackers DAX UCITS 1C.",
    ...
    commentDe: "Der SMI® Index verfolgt die 20 größten und liquidesten Schweizer Aktien und birgt aufgrund seiner starken Gewichtung in wenigen Unternehmen ein bemerkenswertes Konzentrationsrisiko.",
    commentSource: "manual",
  ...
  "IE00BZCQB185": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "India equity — iShares MSCI India UCITS.",
    commentDe: "Indien-Aktien — iShares MSCI India UCITS.",
  ...
  "IE00BFMXYX26": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "China A equity — iShares MSCI China A UCITS.",
    commentDe: "China A-Aktien — iShares MSCI China A UCITS.",
  ...
  "IE00B02KXK85": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "China equity — iShares MSCI China UCITS.",
    commentDe: "China-Aktien — iShares MSCI China UCITS.",
  ...
  "IE00B40B8R38": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Sector US Cons Stap — iShares S&P 500 Consumer Staples Sector UCITS.",
    commentDe: "Sektor US Konsumgüter — iShares S&P 500 Consumer Staples Sector UCITS.",
  ...
  "IE00BMW42181": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Thematic Clean Energy — iShares Global Clean Energy UCITS.",
    commentDe: "Themenbereich Erneuerbare Energien — iShares Global Clean Energy UCITS.",
  ...
  "IE00BYZK4552": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Robotics — iShares Automation & Robotics UCITS.",
    commentDe: "Themenbereich Robotik — iShares Automation & Robotics UCITS.",
  ...
  "IE00BGV5VN51": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Cybersecurity — iShares Digital Security UCITS.",
    commentDe: "Themenbereich Cybersicherheit — iShares Digital Security UCITS.",
  ...
  "IE00BYWQWR46": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Healthcare Innov — iShares Healthcare Innovation UCITS.",
    commentDe: "Themenbereich Gesundheitsinnovation — iShares Healthcare Innovation UCITS.",
  ...
  "IE00BYZK4883": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Ageing Pop — iShares Ageing Population UCITS.",
    commentDe: "Themenbereich Alternde Bevölkerung — iShares Ageing Population UCITS.",
  ...
  "IE00BMDX0K95": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Thematic Megatrends — iShares Smart City Infrastructure UCITS.",
    commentDe: "Thematic Megatrends — iShares Smart City Infrastructure UCITS.",
  ...
  "IE00BJK9H753": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Hydrogen — L&G Hydrogen Economy UCITS.",
    commentDe: "Thematic Hydrogen — L&G Hydrogen Economy UCITS.",
  ...
  "IE00BMWXKN31": I({
    ...
    distribution: "Accumulating",
    currency: "HKD",
    comment: "Thematic AI — WisdomTree Artificial Intelligence UCITS Acc.",
    commentDe: "Thematic AI — WisdomTree Artificial Intelligence UCITS Acc.",
  ...
  "IE00BJ5JNZ06": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Thematic Cybersecurity — WisdomTree Cybersecurity UCITS Acc.",
    commentDe: "Thematic Cybersecurity — WisdomTree Cybersecurity UCITS Acc.",
  ...
  "IE000U9ODG19": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Defense — VanEck Defense UCITS ETF Acc.",
    commentDe: "Thematic Defense — VanEck Defense UCITS ETF Acc.",
  ...
  "IE00BMC38736": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic Defense — HANetf Future of Defence UCITS.",
    commentDe: "Thematic Defense — HANetf Future of Defence UCITS.",
  ...
  "IE00BMW3QX54": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Thematic EV — iShares Electric Vehicles & Driving Tech UCITS.",
    commentDe: "Thematic EV — iShares Electric Vehicles & Driving Tech UCITS.",
  ...
  "IE00BP3QZ601": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Factor Quality — iShares Edge MSCI World Quality Factor UCITS.",
    commentDe: "Factor Quality — iShares Edge MSCI World Quality Factor UCITS.",
  ...
  "IE00BP3QZB59": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Factor Momentum — iShares Edge MSCI World Momentum Factor UCITS.",
    commentDe: "Factor Momentum — iShares Edge MSCI World Momentum Factor UCITS.",
  ...
  "IE00BP3QZ825": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Factor Value — iShares Edge MSCI World Value Factor UCITS.",
    commentDe: "Factor Value — iShares Edge MSCI World Value Factor UCITS.",
  ...
  "IE00BD1F4M44": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Factor MinVol — iShares Edge MSCI World Minimum Volatility UCITS.",
    commentDe: "Factor MinVol — iShares Edge MSCI World Minimum Volatility UCITS.",
  ...
  "IE00B6YX5D40": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Dividend US — SPDR S&P US Dividend Aristocrats UCITS.",
    commentDe: "Dividend US — SPDR S&P US Dividend Aristocrats UCITS.",
  ...
  "IE00B9CQXS71": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Dividend Global — SPDR S&P Global Dividend Aristocrats UCITS.",
    commentDe: "Dividend Global — SPDR S&P Global Dividend Aristocrats UCITS.",
  ...
  "IE00B5M1WJ87": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Dividend World HY — Vanguard FTSE All-World High Dividend Yield UCITS.",
    commentDe: "Dividend World HY — Vanguard FTSE All-World High Dividend Yield UCITS.",
  ...
  "IE00BCHWNQ94": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Dividend World HY — Vanguard FTSE All-World High Dividend Yield UCITS Acc.",
    commentDe: "Dividend World HY — Vanguard FTSE All-World High Dividend Yield UCITS Acc.",
  ...
  "IE00B652H904": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Dividend Eurozone — iShares EURO Dividend UCITS.",
    commentDe: "Dividend Eurozone — iShares EURO Dividend UCITS.",
  ...
  "IE00B3VWMM18": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Small cap World — iShares MSCI World Small Cap UCITS.",
    commentDe: "Small cap World — iShares MSCI World Small Cap UCITS.",
  ...
  "IE00BCBJG560": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Small cap Europe — SPDR MSCI Europe Small Cap UCITS.",
    commentDe: "Small cap Europe — SPDR MSCI Europe Small Cap UCITS.",
  ...
  "IE00BHZPJ569": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "ESG US SRI — iShares MSCI USA SRI UCITS.",
    commentDe: "ESG US SRI — iShares MSCI USA SRI UCITS.",
  ...
  "IE00BG0J4841": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "ESG Europe SRI — iShares MSCI Europe SRI UCITS.",
    commentDe: "ESG Europe SRI — iShares MSCI Europe SRI UCITS.",
  ...
  "IE00BFNM3P36": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "ESG EM SRI — iShares MSCI EM SRI UCITS.",
    commentDe: "ESG EM SRI — iShares MSCI EM SRI UCITS.",
  ...
  "CH0044781232": I({
    ...
    distribution: "Distributing",
    currency: "CHF",
    comment: "Gold (physical) — ZKB Gold ETF AA CHF (CH).",
    commentDe: "Gold (physisch) — ZKB Gold ETF AA CHF (CH).",
  ...
  "DE000A0H0728": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Commodities broad — iShares Diversified Commodity Swap UCITS.",
    commentDe: "Rohstoffe breit — iShares Diversified Commodity Swap UCITS.",
  ...
  "IE00B0M63284": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "REITs Asia — iShares Asia Property Yield UCITS.",
    commentDe: "REITs Asien — iShares Asia Property Yield UCITS.",
  ...
  "IE00B1FZS798": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Govt bonds EUR 7-10 — iShares Core EUR Govt Bond UCITS.",
    commentDe: "Staatsanleihen EUR 7-10 — iShares Core EUR Govt Bond UCITS.",
  ...
  "IE00B3VWN518": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Govt bonds EUR 1-3 — iShares EUR Govt Bond 1-3yr UCITS.",
    commentDe: "Staatsanleihen EUR 1-3 — iShares EUR Govt Bond 1-3yr UCITS.",
  ...
  "IE00B4WXJJ64": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Govt bonds EUR core — iShares Core EUR Govt Bond UCITS.",
    commentDe: "Staatsanleihen EUR Kern — iShares Core EUR Govt Bond UCITS.",
  ...
  "IE00B3VWN179": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Govt bonds US 7-10 — iShares USD Treasury Bond 7-10yr UCITS.",
    commentDe: "Staatsanleihen US 7-10 — iShares USD Treasury Bond 7-10yr UCITS.",
  ...
  "IE00BSKRJZ44": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Govt bonds US core — iShares Core USD Govt Bond UCITS.",
    commentDe: "Staatsanleihen US Kern — iShares Core USD Govt Bond UCITS.",
  ...
  "IE00B1FZS244": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "US Aggregate Bond — iShares Core US Aggregate Bond UCITS.",
    commentDe: "US Aggregate Bond — iShares Core US Aggregate Bond UCITS.",
  ...
  "IE00B0M62X26": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Inflation-linked EUR — iShares EUR Inflation Linked Govt Bond UCITS.",
    commentDe: "Inflationsgebundene EUR — iShares EUR Inflation Linked Govt Bond UCITS.",
  ...
  "IE00B1FZSC47": I({
    ...
    distribution: "Accumulating",
    currency: "USD",
    comment: "Inflation-linked US — iShares USD TIPS UCITS.",
    commentDe: "Inflationsgebundene US — iShares USD TIPS UCITS.",
  ...
  "IE00B3F81R35": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Corp bonds EUR IG — iShares Core EUR Corporate Bond UCITS.",
    commentDe: "Unternehmensanleihen EUR IG — iShares Core EUR Corporate Bond UCITS.",
  ...
  "IE00B3F81G20": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "Corp bonds USD IG — iShares Core USD Corp Bond UCITS.",
    commentDe: "Unternehmensanleihen USD IG — iShares Core USD Corp Bond UCITS.",
  ...
  "IE00B66F4759": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Corp bonds EUR HY — iShares EUR High Yield Corporate Bond UCITS.",
    commentDe: "Unternehmensanleihen EUR HY — iShares EUR High Yield Corporate Bond UCITS.",
  ...
  "IE00BJK55C48": I({
    ...
    distribution: "Accumulating",
    currency: "EUR",
    comment: "Fallen Angels HY — iShares Fallen Angels High Yield Corp Bond UCITS.",
    commentDe: "Fallen Angels HY — iShares Fallen Angels High Yield Corp Bond UCITS.",
  ...
  "IE00B2NPKV68": I({
    ...
    distribution: "Distributing",
    currency: "USD",
    comment: "EM bonds USD — iShares J.P. Morgan EM Bond UCITS.",
    commentDe: "EM-Anleihen USD — iShares J.P. Morgan EM Bond UCITS.",
  ...
  "IE00B5L65R35": I({
    ...
    distribution: "Distributing",
    currency: "GBP",
    comment: "EM bonds USD — iShares JPM USD EM Bond UCITS.",
    commentDe: "EM-Anleihen USD — iShares JPM USD EM Bond UCITS.",
  ...
  "IE00B9M6RS56": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "EM bonds local — iShares J.P. Morgan EM Local Govt Bond UCITS.",
    commentDe: "EM-Anleihen lokal — iShares J.P. Morgan EM Local Govt Bond UCITS.",
  ...
  "IE00BCRY6557": I({
    ...
    distribution: "Distributing",
    currency: "EUR",
    comment: "Money market USD — PIMCO US Dollar Short Maturity UCITS.",
    commentDe: "Geldmarkt USD — PIMCO US Dollar Short Maturity UCITS.",
    ...
    commentDe: "EURO STOXX 50 (nur Blue-Chips der Eurozone, 50 Namen); viel enger als die breiten MSCI/FTSE Europa-Alternativen — keine UK- oder Schweizer Beteiligungen.",
    commentSource: "manual",
    ...
    commentDe: "Der STOXX 50 ESG verfolgt große Unternehmen der Eurozone und schließt Firmen aus, die in umstrittene Waffen, Tabak, fossile Brennstoffe oder Verstöße gegen die Prinzipien des UN Global Compact verwickelt sind.",
    commentSource: "manual",
    ...
    commentDe: "Der S&P 500® Index verfolgt die 500 größten US-Aktien.",
    commentSource: "manual",
  ...
  "IE00BDBRT036": I({
    ...
    commentDe: "Der MSCI Japan (CHF Hedged) Index verfolgt führende Aktien auf dem japanischen Markt. Währungsabsicherung in Schweizer Franken (CHF).",
    commentSource: "manual",
  ...
  "LU2573967036": I({
    ...
    currency: "USD",
    comment: "",
    listings: { "LSE": { ticker: "LEMA" }, "XETRA": { ticker: "LEMA" } },
    defaultExchange: "LSE",
    aumMillionsEUR: 4504,
    inceptionDate: "2020-12-03",
  }),
  "IE000GA3D489": I({
    name: "ARK Innovation UCITS ETF USD Accumulating",
    isin: "IE000GA3D489",
    terBps: 75,
    domicile: "Ireland",
    replication: "Physical",
  ...
  "IE00BD1JRY91": I({
    ...
    commentDe: "Der FTSE Emerging Index verfolgt Aktien aus Schwellenländern weltweit.",
    commentSource: "manual",
  ...
  "IE00B42WWV65": I({
    ...
    commentDe: "Der FTSE Developed Index verfolgt die größten Aktien in entwickelten Märkten weltweit.",
    commentSource: "manual",
  ...
  "IE0005042456": I({
    ...
    commentDe: "Der Vanguard FTSE Developed Europe UCITS ETF (EUR) Accumulating zielt darauf ab, den FTSE Developed Europe Index nachzubilden.",
    commentSource: "manual",
    ...
    commentDe: "Der FTSE Developed Europe ex UK Index verfolgt große und mittelgroße Aktien aus entwickelten Ländern in Europa, ohne das UK.",
    commentSource: "manual",
...
const BUCKETS: Record<string, BucketAssignment> = {
  ...
  "Equity-USA": B({
    ...
    pool: ["IE0031442068", "IE00B6YX5D40", "IE00BD4TXW66"],
  }),
  ...
  "Equity-Japan": B({
    ...
    pool: ["IE00B53QDK08", "IE00B02KXH56", "LU0274209740", "IE00B8J37J31"],
  }),
  "Equity-EM": B({
    default: "IE00BKM4GZ66",
    alternatives: ["IE00BK5BR733", "IE00BTJRMP35"],
    pool: ["IE00B0M63177", "IE00B8KGV557", "IE00B0M63730", "IE00BZCQB185", "IE00B02KXK85", "LU2573967036", "IE00B3VVMM84", "LU0292100046"],
  }),
  "Equity-USA-EUR": B({
  ...
  "Equity-Technology": B({
    ...
    pool: ["IE0032077012", "IE00BMFKG444", "IE00BYVQ9F29", "LU1681038243", "IE00BYZK4552", "IE00BLCHJB90", "IE000GA3D489"],
  }),
  "Equity-Healthcare": B({
    default: "IE00BYZK4776",
    alternatives: ["IE00BM67HK77", "IE00B43HR379"],
    pool: ["IE00BJ5JNZ06", "IE00BMW42181"],
  }),
  "Equity-Sustainability": B({
    default: "IE00B1XNHC34",
    alternatives: ["IE00BLRB0242"],
    pool: ["IE00BDBRT036"],
  }),
